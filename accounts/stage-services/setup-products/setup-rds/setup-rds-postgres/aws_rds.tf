...
module "db_postgres" {
  ...
  identifier = "rds-postgres-${local.aws_environment}-services"
  ...
  db_name  = "rds_postgres_${local.aws_environment}_services"
  ...
  monitoring_role_name   = "rds-monitoring-role-${local.aws_environment}"
