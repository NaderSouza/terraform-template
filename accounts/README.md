...
- **Serviços de Produto:** Provisiona os principais serviços da aplicação, como o cluster EKS e os bancos de dados RDS. Para uma análise técnica detalhada do código Terraform desses serviços, consulte a [Documentação Técnica dos Produtos](./vitrify-prod-services/setup-products/README.md).
